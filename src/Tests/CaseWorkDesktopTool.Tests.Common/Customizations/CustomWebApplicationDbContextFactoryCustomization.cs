...
using CaseWorkDesktopTool.Api;
using CaseWorkDesktopTool.Api.Client.Extensions;
using CaseWorkDesktopTool.Client;
using CaseWorkDesktopTool.Client.Contracts;
using CaseWorkDesktopTool.Infrastructure.Database;
using CaseWorkDesktopTool.Tests.Common.Seeders;
...
namespace CaseWorkDesktopTool.Tests.Common.Customizations
{
